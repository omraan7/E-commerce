    ...
    <>
      ...
      <div className=" container mx-auto h-20 flex  gap-3 items-center justify-between">
        <div className="flex  gap-3 items-center">
          <div className="w-2 h-8 rounded-2xl bg-main-color "> </div>
        ...
        <div className="text-md md:text-2xl">
          <Link href="Categories" className="text-main-color flex items-center gap-1">View All Categories <ArrowRight /></Link>
        </div>
      </div>
