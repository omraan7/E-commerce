      ...
      <div className="max-w-6xl mx-auto px-4 pb-6 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-main-color rounded-lg flex items-center justify-center">
        ...
        <a href="#" className="flex items-center gap-1 text-main-color text-sm font-medium hover:underline">
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="flex items-center gap-3">
              <svg className="w-7 h-7 text-main-color shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                {feat.icon}
              </svg>
              <div>
